...
}), 'undefined' != typeof window && null !== window ? window.P = window.Promise : 'undefined' != typeof self && null !== self && (self.P = self.Promise); /*! modernizr 3.6.0 (Custom Build) | MIT *
 * https://modernizr.com/download/?-csstransforms-csstransforms3d-csstransitions-touchevents-addtest-domprefixes-prefixes-setclasses-testallprops-testprop-teststyles !*/
!function (e, n, t) {
    function r(e, n) {
        return typeof e === n
    }
    function o() {
        ...
        for (var l in S) if (S.hasOwnProperty(l)) {
            if (e = [
            ], n = S[l], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) e.push(n.options.aliases[t].toLowerCase());
    ...
    function s(e) {
        ...
        Modernizr._config.enableClasses && (n += ' ' + t + e.join(' ' + t), b ? T.className.baseVal = n : T.className = n)
    }
    function i(e, n) {
        if ('object' == typeof e) for (var t in e) j(e, t) && i(t, e[t]);
        else {
            e = e.toLowerCase();
            var r = e.split('.'),
                o = Modernizr[r[0]];
            ...
            n = 'function' == typeof n ? n()  : n,
                1 == r.length ? Modernizr[r[0]] = n : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = n),
                s([(n && 0 != n ? '' : 'no-') + r.join('-')]),
    ...
    function l() {
        var e = n.body;
        return e || (e = a(b ? 'svg' : 'body'), e.fake = !0),
            e
    }
    function u(e, t, r, o) {
        var s,
            ...
            d = a('div'),
            p = l();
        if (parseInt(r, 10)) for (; r--; ) u = a('div'),
            u.id = o ? o[r] : c + (r + 1),
            d.appendChild(u);
        return s = a('style'),
            s.type = 'text/css',
            ...
            d.id = c,
        p.fake && (p.style.background = '', p.style.overflow = 'hidden', f = T.style.overflow, T.style.overflow = 'hidden', T.appendChild(p)),
            i = t(d, e),
            p.fake ? (p.parentNode.removeChild(p), T.style.overflow = f, T.offsetHeight)  : d.parentNode.removeChild(d),
            !!i
    }
    function f(e, n) {
        return !!~('' + e).indexOf(n)
    ...
    function p(e, n, t) {
        var o;
        for (var s in e) if (e[s] in n) return t === !1 ? e[s] : (o = n[e[s]], r(o, 'function') ? d(o, t || n)  : o);
        return !1
    }
    function m(n, t, r) {
        var o;
    ...
    function g(e, n, o, s) {
        ...
        for (var u, d, p, m, h, g = [
            ...
            'tspan',
            'samp'
        ]; !q.style && g.length; ) u = !0,
            q.modElem = a(g.shift()),
            q.style = q.modElem.style;
        for (p = e.length, d = 0; p > d; d++) if (m = e[d], h = q.style[m], f(m, '-') && (m = c(m)), q.style[m] !== t) {
            if (s || r(o, 'undefined')) return i(),
                'pfx' == n ? m : !0;
            try {
                q.style[m] = o
            } catch (y) {
            }
            if (q.style[m] != h) return i(),
                'pfx' == n ? m : !0
        }
        return i(),
            !1
    ...
    function y(e, n, t, o, s) {
        ...
        return r(n, 'string') || r(n, 'undefined') ? g(a, n, o, s)  : (a = (e + ' ' + z.join(i + ' ') + i).split(' '), p(a, n, t))
    }
    function _(e, n, r) {
        return y(e, t, t, n, r)
    }
    ...
    var E = 'CSS' in e && 'supports' in e.CSS,
        N = 'supportsCSS' in e;
    Modernizr.addTest('supports', E || N);
    var A = w._config.usePrefixes ? P.split(' ')  : [
    ];
    w._cssomPrefixes = A;
    ...
    w.testAllProps = y,
        ...
        Modernizr.addTest('csstransforms3d', function () {
            return !!_('perspective', '1px', !0)
        }),
        Modernizr.addTest('csstransitions', _('transition', 'all', !0)),
        o(),
        s(C),
        delete w.addTest,
...
}(window, document); var requirejs, require, requireAsync, define; !function (global, Promise, undef) {
    ...
    function eachProp(e, n) {
        var r;
        for (r in e) if (hasProp(e, r) && n(e[r], r)) break
    }
    function mixin(e, n, r, t) {
        return n && eachProp(n, function (n, i) {
            !r && hasProp(e, i) || (!t || 'object' != typeof n || !n || Array.isArray(n) || 'function' == typeof n || n instanceof RegExp ? e[i] = n : (e[i] || (e[i] = {
            }), mixin(e[i], n, r, t)))
        }),
            e
    }
    ...
    function newContext(e) {
        function n(e, n, r) {
            var t,
                ...
                g = O.map,
                h = g && g['*'];
            if (e && (s = (e = e.split('/')).length - 1, O.nodeIdCompat && jsSuffixRegExp.test(e[s]) && (e[s] = e[s].replace(jsSuffixRegExp, '')), '.' === e[0].charAt(0) && l && (e = l.slice(0, l.length - 1).concat(e)), function (e) {
                var n,
                    r,
                    t = e.length;
                for (n = 0; n < t; n++) if ('.' === (r = e[n])) e.splice(n, 1),
                    n -= 1;
                else if ('..' === r) {
                ...
                e: for (o = (i = e.split('/')).length; o > 0; o -= 1) {
                    if (u = i.slice(0, o).join('/'), l) for (a = l.length; a > 0; a -= 1) if ((t = getOwn(g, l.slice(0, a).join('/'))) && (t = getOwn(t, u))) {
                        c = t,
                            f = o;
                        break e
                    }
                    !p && h && getOwn(h, u) && (p = getOwn(h, u), d = o)
                }
                !c && p && (c = p, f = d),
                c && (i.splice(0, f, c), e = i.join('/'))
            }
            return getOwn(O.pkgs, e) || e
        }
        function r(e) {
            var n,
                r,
            ...
            for (n = 0; n < queue.length; n += 1) {
                ...
                n -= 1,
                (r = (t = queue.shift()) [0]) in A || r in R || (r in C ? v.apply(undef, t)  : R[r] = t)
            }
            e && (i = getOwn(O.shim, e) || {
            }, v(e, i.deps || [
            ], i.exportsFn))
        ...
        function t(e, t) {
            var i = function (n, o, a, u) {
                var s,
                    c;
                if (t && r(), 'string' == typeof n) {
                    if (j[n]) return j[n](e);
                    if (!((s = b(n, e, !0).id) in A)) throw new Error('Not loaded: ' + s);
                    return A[s]
                }
                return n && !Array.isArray(n) && (c = n, n = undef, Array.isArray(o) && (n = o, o = a, a = u), t) ? i.config(c) (n, o, a)  : (o = o || function () {
            ...
            return i.isBrowser = 'undefined' != typeof document && 'undefined' != typeof navigator,
                i.nameToUrl = function (e, n, r) {
                    var t,
                        ...
                        f,
                        p = getOwn(O.pkgs, e);
                    if (p && (e = p), f = getOwn(L, e)) return i.nameToUrl(f, n, r);
                    if (urlRegExp.test(e)) s = e + (n || '');
                    else {
                        for (t = O.paths, a = (o = e.split('/')).length; a > 0; a -= 1) if (u = o.slice(0, a).join('/'), c = getOwn(t, u)) {
                            Array.isArray(c) && (c = c[0]),
                                o.splice(0, a, c);
                            break
                        }
                        s = o.join('/'),
                            s = ('/' === (s += n || (/^data\:|^blob\:|\?/.test(s) || r ? '' : '.js')).charAt(0) || s.match(/^[\w\+\.\-]+:/) ? '' : O.baseUrl) + s
                    }
                    return O.urlArgs && !/^blob\:/.test(s) ? s + O.urlArgs(e, s)  : s
                },
                i.toUrl = function (r) {
                    var t,
                        o = r.lastIndexOf('.'),
                        a = r.split('/') [0];
                    return - 1 !== o && (!('.' === a || '..' === a) || o > 1) && (t = r.substring(o, r.length), r = r.substring(0, o)),
                        i.nameToUrl(n(r, e), t, !0)
                },
                i.defined = function (n) {
                    return b(n, e, !0).id in A
                },
                i.specified = function (n) {
                    return (n = b(n, e, !0).id) in A || n in C
                },
                i
        }
        function i(e, n, r) {
            e && (A[e] = r, requirejs.onResourceLoad && requirejs.onResourceLoad(E, n.map, n.deps)),
                n.finished = !0,
                n.resolve(r)
        }
        function o(e, n) {
        ...
        function a(e) {
            ...
            var n,
                r = e.map.id;
            try {
                n = E.execCb(r, e.factory, e.values, A[r])
            } catch (n) {
                return o(e, n)
            }
            r ? n === undef && (e.cjsModule ? n = e.cjsModule.exports : e.usingExports && (n = A[r]))  : M.splice(M.indexOf(e), 1),
                i(r, e, n)
        }
        function u(e, n) {
            this.rejected || this.depDefined[n] || (this.depDefined[n] = !0, this.depCount += 1, this.values[n] = e, this.depending || this.depCount !== this.depMax || a(this))
        }
        function s(e, n) {
            var r = {
            };
            return r.promise = new Promise(function (n, t) {
                r.resolve = n,
                    r.reject = function (n) {
                        e || M.splice(M.indexOf(r), 1),
                            t(n)
                    }
            }),
                r.map = e ? n || b(e)  : {
        ...
        function c(e, n) {
            var r;
            return e ? (r = e in C && C[e]) || (r = C[e] = s(e, n))  : (r = s(), M.push(r)),
                r
        }
        function f(e, n) {
            return function (r) {
                e.rejected || (r.dynaId || (r.dynaId = 'id' + (D += 1), r.requireModules = [
                    n
                ]), o(e, r))
            }
        }
        function p(e, n, r, t) {
            r.depMax += 1,
                y(e, n).then(function (e) {
                    r.depFinished(e, t)
                }, f(r, e.id)).catch (f(r, r.map.id))
        }
        function d(e, n, a) {
            e.load(n.n, t(a), function (e) {
                function n(n) {
                    t || i(e, c(e), n)
                }
                var t;
                return n.error = function (n) {
                    ...
                    n.fromText = function (n, i) {
                        var a,
                            u = c(e),
                            s = b(b(e).n),
                            f = s.id;
                        t = !0,
                            u.factory = function (e, n) {
                                return n
                            },
                        i && (n = i),
                        hasProp(O.config, e) && (O.config[f] = O.config[e]);
                        try {
                            x.exec(n)
                        } catch (e) {
                            (a = new Error('fromText eval for ' + f + ' failed: ' + e)).requireType = 'fromtexteval',
                                o(u, a)
                        }
                        r(f),
                            u.deps = [
        ...
        function l(e) {
            var n,
                r = e ? e.indexOf('!')  : - 1;
            return r > - 1 && (n = e.substring(0, r), e = e.substring(r + 1, e.length)),
                [
                    n,
                    e
                ]
        ...
        function g(e, n, r) {
            var t = e.map.id;
            n[t] = !0,
            !e.finished && e.deps && e.deps.forEach(function (t) {
                var i = t.id,
                    o = !hasProp(j, i) && c(i, t);
                !o || o.finished || r[i] || (hasProp(n, i) ? e.deps.forEach(function (n, r) {
                    n.id === i && e.depFinished(A[i], r)
                })  : g(o, n, r))
            }),
                r[t] = !0
        }
        function h(e) {
            var n,
                ...
                a = 1000 * O.waitSeconds,
                u = a && S + a < (new Date).getTime();
            if (0 === U && (e ? e.finished || g(e, {
            }, {
                ...
                for (r in C) (t = C[r]).finished || i.push(t.map.id);
                (n = new Error('Timeout for modules: ' + i)).requireModules = i,
                    n.requireType = 'timeout',
                    i.forEach(function (e) {
                        o(c(e), n)
                    })
            } else (U || M.length) && (q || (q = !0, setTimeout(function () {
                q = !1,
                    h()
            }, 70)))
        }
        function m(e) {
            return setTimeout(function () {
                e.dynaId && I[e.dynaId] || (I[e.dynaId] = !0, x.onError(e))
            }),
                e
        }
        var x,
            ...
            L = obj(),
            N = Promise.resolve();
        return w = 'function' == typeof importScripts ? function (e) {
                var n = e.url;
                F[n] || (F[n] = !0, c(e.id), importScripts(n), r(e.id))
            }
            : function (e) {
                var n,
                    t = e.id,
                    i = e.url;
                F[i] || (F[i] = !0, (n = document.createElement('script')).setAttribute('data-requiremodule', t), n.type = O.scriptType || 'text/javascript', n.charset = 'utf-8', n.async = !0, U += 1, n.addEventListener('load', function () {
                    U -= 1,
                        r(t)
                    ...
                    if (r && Array.isArray(r) && r.length > 1) {
                        ...
                        var i = c(t);
                        i.map = b(t),
                            i.map.url = x.nameToUrl(t),
                            w(i.map)
                    } else (e = new Error('Load failed: ' + t + ': ' + n.src)).requireModules = [
                        t
                    ],
                        e.requireType = 'scripterror',
                        o(c(t), e)
                }, !1), n.src = i, 10 === document.documentMode ? asap.then(function () {
            ...
            y = function (e, n) {
                ...
                if (i in R) r = R[i],
                    delete R[i],
                    v.apply(undef, r);
                else if (!(i in C)) if (e.pr) {
                    if (!(t = getOwn(L, i))) return y(b(e.pr)).then(function (r) {
                        var t = e.prn ? e : b(i, n, !0),
                            o = t.id,
                            a = getOwn(O.shim, o);
                        return o in k || (k[o] = !0, a && a.deps ? x(a.deps, function () {
                            d(r, t, n)
                        })  : d(r, t, n)),
                            c(o).promise
                    });
            ...
            b = function (e, r, t) {
                ...
                return a = l(e),
                    u = a[0],
                    e = a[1],
                    !u && f in P ? P[f] : (u && (i = (u = n(u, r, t)) in A && A[u]), u ? i && i.normalize ? (e = i.normalize(e, function (e) {
                        return function (r) {
                            return n(r, e, !0)
                        }
                    }(r)), c = !0)  : e = - 1 === e.indexOf('!') ? n(e, r, t)  : e : (u = (a = l(e = n(e, r, t))) [0], e = a[1], o = x.nameToUrl(e)), s = {
                        id: u ? u + '!' + e : e,
                        n: e,
                        pr: u,
                        url: o,
            ...
            j = {
                ...
                module: function (e) {
                    return {
                        ...
                        exports: j.exports(e),
                        config: function () {
                            return getOwn(O.config, e) || {
                            }
                        }
                    }
                }
            },
            v = function (e, n, r, t, o) {
                if (e) {
                    if (e in T) return;
                    T[e] = !0
                }
                var u = c(e);
                return n && !Array.isArray(n) && (r = n, n = [
                ]),
                    n = n ? slice.call(n, 0)  : null,
                t || (hasProp(O, 'defaultErrback') ? O.defaultErrback && (t = O.defaultErrback)  : t = m),
                t && u.promise.catch (t),
                    o = o || e,
                    'function' == typeof r ? (!n.length && r.length && (r.toString().replace(commentRegExp, commentReplace).replace(cjsRequireRegExp, function (e, r) {
                        n.push(r)
                    }), n = (1 === r.length ? [
                        'require'
                    ] : [
                        ...
                        'exports',
                        'module'
                    ]).concat(n)), u.factory = r, u.deps = n, u.depending = !0, n.forEach(function (r, t) {
                        var i;
                        n[t] = i = b(r, o, !0),
                            'require' === (r = i.id) ? u.values[t] = j.require(e)  : 'exports' === r ? (u.values[t] = j.exports(e), u.usingExports = !0)  : 'module' === r ? u.values[t] = u.cjsModule = j.module(e)  : void 0 === r ? u.values[t] = void 0 : p(i, o, u, t)
                    }), u.depending = !1, u.depCount === u.depMax && a(u))  : e && i(e, u, r),
                    S = (new Date).getTime(),
                e || h(u),
                    u.promise
            },
            x = t(null, !0),
            x.config = function (n) {
                if (n.context && n.context !== e) {
                    var r = getOwn(contexts, n.context);
                    return r ? r.req.config(n)  : newContext(n.context).config(n)
                }
                if (P = obj(), n.baseUrl && '/' !== n.baseUrl.charAt(n.baseUrl.length - 1) && (n.baseUrl += '/'), 'string' == typeof n.urlArgs) {
                    var t = n.urlArgs;
                    n.urlArgs = function (e, n) {
                ...
                return eachProp(n, function (e, n) {
                    o[n] ? (O[n] || (O[n] = {
                    }), mixin(O[n], e, !0, !0))  : O[n] = e
                }),
                n.bundles && eachProp(n.bundles, function (e, n) {
                    e.forEach(function (e) {
                        e !== n && (L[e] = n)
                    })
                }),
                n.shim && (eachProp(n.shim, function (e, n) {
                    Array.isArray(e) && (e = {
                        deps: e
                    }),
                    !e.exports && !e.init || e.exportsFn || (e.exportsFn = function (e) {
                        return function () {
                            var n;
                            return e.init && (n = e.init.apply(global, arguments)),
                            n || e.exports && getGlobal(e.exports)
                        }
                    }(e)),
                        i[n] = e
                }), O.shim = i),
                n.packages && n.packages.forEach(function (e) {
                    var n;
                    n = (e = 'string' == typeof e ? {
                            name: e
                        }
                        : e).name,
                    e.location && (O.paths[n] = e.location),
                        O.pkgs[n] = e.name + '/' + (e.main || 'main').replace(currDirRegExp, '').replace(jsSuffixRegExp, '')
                }),
                (n.deps || n.callback) && x(n.deps, n.callback),
                    x
            },
    ...
    if ('function' != typeof requirejs) {
        ...
        'function' != typeof require && (require = requireAsync = topReq),
        ...
        topReq.isBrowser && !contexts._.config.skipDataMain && (dataMain = document.querySelectorAll('script[data-main]') [0], (dataMain = dataMain && dataMain.getAttribute('data-main')) && (dataMain = dataMain.replace(jsSuffixRegExp, ''), bootstrapConfig && bootstrapConfig.baseUrl || - 1 !== dataMain.indexOf('!') || (src = dataMain.split('/'), dataMain = src.pop(), subPath = src.length ? src.join('/') + '/' : './', topReq.config({
            baseUrl: subPath
        })), topReq([dataMain])))
    }
}(this, 'undefined' != typeof Promise ? Promise : void 0); !function (root, factory) {
    root.requireWidget = factory(require)
}(this, function (require) {
    var widgetConfig = null,
        _requireWidget = function _requireWidget(widgetInstance, widgetModule, scriptPath) {
            var scriptPathTemp = scriptPath || 'widgets';
            if (!widgetConfig) widgetConfig = require.contexts._.config;
            var widgetName = widgetModule.replace('pf-widget-', '');
            if (!widgetConfig.paths[widgetModule]) widgetConfig.paths[widgetModule] = be.contextRoot + '/static/fipo/' + scriptPathTemp + '/' + widgetName + '/js/' + widgetName;
            require([widgetModule], function widgetRequireFn(app) {
                app.call(null, widgetInstance)
            })
        };
    return function returnFn() {
        _requireWidget.apply(null, arguments)
    }
}); requirejs.config({
