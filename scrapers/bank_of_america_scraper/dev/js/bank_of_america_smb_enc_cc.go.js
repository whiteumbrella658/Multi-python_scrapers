// from https://secure.bankofamerica.com/login/sign-in/cc.go
// for login from https://www.bankofamerica.com/smallbusiness/
try {
  (function () {
    ...
    // TODO called from Ba - encodes JSON.strigify(s)
    function Aa(a) {
      try {
    ...
    function Ba() {
      ...
      // TODO Final encrypt step, Q is JSON
    ...
    // TODO updates session and local storage
    //  v = K[:24] from Ba()
    function Ka(a, b) {
      if (a) {
        var c = a.getItem(U)
    ...
    // TODO stores vals to session object storage
    function g(a, b, c, d) {
      V && V.apply(null, [a, b])
      s[a] = b
    }
    // TODO call encrypt fn here
    function Na(a) {
      try {
        var b = Fb[a[0]]
    ...
    var Ha = 8, Ia = 1024, Ja = 8192, xa = 32768, x = 2097152, Ya = 33554432, Wa = 268435456, Xa = 536870912,
      // TODO Fb is encrypter
      U = "_cc_ck", Fb = {
        run: function (a) {
          B = a
          // TODO changing -- need to load each time
          // will be "_t" : "NThlZTI2YmMtYTFmOS00ZGVhLTk3ZGEtNTI0ODJmNzFhOTRiOjE1NTEwMDYzNzAzMjM"
          // in s (storage to encrypt)
          // also K[:24] may be used for
          K = "NThlZTI2YmMtYTFmOS00ZGVhLTk3ZGEtNTI0ODJmNzFhOTRiOjE1NTEwMDYzNzAzMjM"
    ...
    // TODO called from Ba() as part of   Da.encode(Aa(Q.stringify(s)))
    var Da = {
