...
function encriptarDataLogon(username, password, flag) {
    var _0xcb69x5 = _0x48e2[0]
    var _0xcb69x6 = 1000
    var _0xcb69x7 = 128
    var _0xcb69x8 = CryptoJS[_0x48e2[4]][_0x48e2[3]][_0x48e2[2]](128 / 8).toString(CryptoJS[_0x48e2[1]].Hex)
    var _0xcb69x9 = CryptoJS[_0x48e2[4]][_0x48e2[3]][_0x48e2[2]](128 / 8).toString(CryptoJS[_0x48e2[1]].Hex)
    var _0xcb69xa = username + _0x48e2[5] + password + _0x48e2[5] + flag + _0x48e2[5] + Date[_0x48e2[6]]()
    var _0xcb69xb = new AesUtil(_0xcb69x7, _0xcb69x6)
    var _0xcb69xc = _0xcb69xb[_0x48e2[7]](_0xcb69x9, _0xcb69x8, _0xcb69x5, _0xcb69xa)
    _0xcb69xc = _0x48e2[8] + _0xcb69x8 + _0x48e2[5] + _0xcb69x9 + _0x48e2[5] + _0xcb69xc
    return _0xcb69xc
}


/**
 * node kutxa_encrypter.js 6190301 123456 'false'
 * will encrypt DATA_LOGON_PORTAL param
 */
(function () {
    ...
    var encrypted = encriptarDataLogon(username, userpass, flag);
